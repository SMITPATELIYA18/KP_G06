...
public class SearchReposFeatureTest {
    ...
    public void should_ReturnOK_when_ValidGETRequest() {
        ...
        System.out.println("Extracted value: " + contentAsString(homePageResult));
    ...
    public void should_Return10Repos_when_ValidSearchRequest() throws Exception {
        ...
        SearchRepository sampleSearchResult = testGitHubAPIImpl.getRepositoryFromSearchBar("github").toCompletableFuture().get(10, TimeUnit.SECONDS);

        assertEquals(10, sampleSearchResult.getRepositoryList().size());
    }
    ...
    public void testStuff() throws Exception {
        ...
        SearchRepository sampleSearchResult = testGitHubAPIImpl.getRepositoryFromSearchBar("").toCompletableFuture().get(10, TimeUnit.SECONDS);

        // System.out.println(sampleSearchResult.getRepositoryList());
        // assertEquals(10, sampleSearchResult.getRepositoryList().size());
    }
}
