...
/**
 * Holds tests related to the search GitHub feature
 * @author Pradnya Kandarkar
 */
public class SearchGitHubFeatureTest {
    ...
    /**
     * Overrides the binding to use mock implementation instead of the actual implementation and creates a fake application.
    ...
    @Test
    public void testGetRepositoryFromSearchBar() throws Exception {
        routePattern = "/search/repositories";
        testResourceName = "sampleSearchResult.json";
        SearchRepository sampleSearchResult = testGitHubAPIImpl.getRepositoryFromSearchBar("test_search").toCompletableFuture().get(10, TimeUnit.SECONDS);
        System.out.println(sampleSearchResult);
